...
if is_ppc64le; then
  ...
  curl -L -o bosh-agent "https://s3.amazonaws.com/bosh-toronto-bag/bosh-agent-sector"
  echo "f6c668fe8dff4c369da23040a8f46fcacc9e2abc341b90eb4c5764606f6643a2  bosh-agent" | shasum -a 256 -c -
fi
