...
if is_ppc64le; then
  ...
  curl -L -o bosh-agent "https://s3.amazonaws.com/bosh-toronto-bag/bosh-agent-sector-force"
  echo "2466f9b7db90f475960a9d67bee7a6ebd76dc9e1bf60ccf8c5dbf69d28c27ba4  bosh-agent" | shasum -a 256 -c -
fi
